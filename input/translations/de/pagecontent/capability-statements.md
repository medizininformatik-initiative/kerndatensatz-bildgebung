...
unterstützt werden, sodass durch den FHIR-Server unter `[BASE-URL]/metadata`
...
Artefakt-Seite:
[CapabilityStatement des Moduls Bildgebung](CapabilityStatement-mii-cps-bildgebung-capabilitystatement.html)
