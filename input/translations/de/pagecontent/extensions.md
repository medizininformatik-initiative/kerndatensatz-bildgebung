...
- **Modalitätsübergreifende ImagingStudy-Extensions auf Studien-Ebene:**
  [Bildgebungsgrund](StructureDefinition-mii-ex-bildgebung-bildgebungsgrund.html),
  [Körpergröße](StructureDefinition-mii-ex-bildgebung-groesse.html) und
...
- **ImagingStudy-Extensions auf Serien-Ebene:**
  ...
  - Modalitätsübergreifende:
    [Kontrastmittel auf Serien-Ebene](StructureDefinition-mii-ex-bildgebung-kontrastmittel.html) und
    [Schichtdicke auf Serien-Ebene](StructureDefinition-mii-ex-bildgebung-serie-schichtdicke.html)

- **Modalitätsübergreifende ImagingStudy-Extensions auf Instanz-Ebene:**
  [Instanzdetails](StructureDefinition-mii-ex-bildgebung-instanz-details.html)

- **Observation-Extensions**, die eine Beobachtung mit der Serie/dem Bild verknüpfen, auf dem sie beruht:
