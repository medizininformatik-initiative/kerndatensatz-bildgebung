...
Diese Seite listet die FHIR-Profile des Moduls **Bildgebung**. Die
Extensions des Moduls sind auf der [Extensions-Seite](extensions.html)
aufgeführt; die vollständige, automatisch generierte Liste aller Artefakte
findet sich in der [Artefakt-Übersicht](artifacts.html).
...
[Deutschen Basisprofile](https://simplifier.net/basisprofil-de-r4) von HL7
Deutschland.
...
FHIR-Profile wird in textueller Form unterhalb der jeweiligen Profile
erläutert.
...
Die MII-weiten Namenskonventionen für FHIR-Ressourcen (Modul-Bezeichnungen,
Präfixe der Ressourcentypen, Regeln für `title`, `name`, `id` und `url`)
werden zentral im
[Kerndatensatz-Wiki](https://github.com/medizininformatik-initiative/kerndatensatz-meta/wiki)
gepflegt und hier nicht wiederholt.
