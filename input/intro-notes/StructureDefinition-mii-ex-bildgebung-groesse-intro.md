This extension is used to record the patient's height. This attribute is intended to use the value from the corresponding DICOM tag (Patient's Size [0010,1020]).
