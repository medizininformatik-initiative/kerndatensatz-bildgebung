The NM (nuclear medicine imaging) extension enables the capture of relevant DICOM tags in order to draw conclusions about the image acquisition.
...
- Total radionuclide dose ["0018, 1074" RadionuclideTotalDose] in _megabecquerel [MBq]_ (Note: For PT, on the other hand, the unit Bq is normally used!)
