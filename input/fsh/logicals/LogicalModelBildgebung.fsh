...
* Studie 0..* BackboneElement "Studie" "Bildgebungsstudie"
  ...
  * Serien 0..* BackboneElement "Serien" "Die Serien der DICOM-Studie"
    ...
    * ModalitaetMR 0..1 BackboneElement "Modalitaet MR" "Modalitaet Kernspintomographie"
      ...
      * Echozeit_TE 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Echozeit (TE)" "Zeitintervall zwischen der Anregung und der Messung des MR-Signals in ms"
      * Repetitionszeit_TR 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Repetitionszeit (TR)" "Zeit, die bei der MRT zwischen zwei Anregungspulsen vergeht in ms"
      * Inversionszeit_TI 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Inversionszeit (TI)" "Zeit, die beim MRT zwischen dem 180°-Umkehrpuls und dem eigentlichen 90°-Anregungspuls vergeht in ms"
...
* Studie -> "ImagingStudy"
  ...
  * Serien -> "ImagingStudy.series"
    ...
    * ModalitaetMR -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-mr)"
      ...
      * Echozeit_TE -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-mr)"
      * Repetitionszeit_TR -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-mr)"
      * Inversionszeit_TI -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-mr)"
