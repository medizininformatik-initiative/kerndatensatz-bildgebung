...
* Studie 0..* BackboneElement "Studie" "Bildgebungsstudie"
  ...
  * Serien 0..* BackboneElement "Serien" "Die Serien der DICOM-Studie"
    ...
    * Maximale Röntgenröhrenspannung 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Maximale Röntgenröhrenspannung" "Maximale Röntgenröhrenspannung in kV"
    ...
    * Scanning Sequenz 1..* http://hl7.org/fhir/StructureDefinition/CodeableConcept "Scanning Sequenz" "Code der aktuellen Scanning Sequenz"
    * Scanning Sequenz Untervariante 1..1 http://hl7.org/fhir/StructureDefinition/CodeableConcept "Scanning Sequenz Untervariante" "Code der aktuellen Scanning Sequenz Untervariante"
    * Magnetische Feldstärke 1..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Magnetische Feldstärke" "Magnetische Feldstärke des Kernspins in T"
    ...
    * Gesamte Radionukliddosis 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Gesamte Radionukliddosis" "Gesamte verabreichte Radionukliddosis in MBq"
...
* Studie -> "ImagingStudy"
  ...
  * Serien -> "ImagingStudy.series"
    ...
    * Maximale Röntgenröhrenspannung -> "ImagingStudy.series.extension(TODO)"
    * Expositionszeit -> "ImagingStudy.series.extension(TODO)"
    * Exposition -> "ImagingStudy.series.extension(TODO)"
    * Röntgenröhrenstrom -> "ImagingStudy.series.extension(TODO)"
    * CTDIVolume -> "ImagingStudy.series.extension(TODO)"
    * Scanning Sequenz -> "ImagingStudy.series.extension(TODO)"
    * Scanning Sequenz Untervariante -> "ImagingStudy.series.extension(TODO)"
    * Magnetische Feldstärke -> "ImagingStudy.series.extension(TODO)"
    * Radiopharmakon -> "ImagingStudy.series.extension(TODO)"
    * Applikationsstartzeit -> "ImagingStudy.series.extension(TODO)"
    * Reskaliserungstyp -> "ImagingStudy.series.extension(TODO)"
    * Gesamte Radionukliddosis -> "ImagingStudy.series.extension(TODO)"
    * Halbwertszeit -> "ImagingStudy.series.extension(TODO)"
