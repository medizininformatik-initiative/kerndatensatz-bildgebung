...
* Geraet 0..1 BackboneElement "Gerät" "Gerät zur Bildgebung"
  * Hersteller 0..1 http://hl7.org/fhir/StructureDefinition/string "Hersteller" "Hersteller des Geräts"
  * Geraetename 0..1 http://hl7.org/fhir/StructureDefinition/string "Gerätename" "Name des Geräts"
...
* Studie 0..* BackboneElement "Studie" "Bildgebungsstudie"
  ...
  * Bildgebungsprozedur 0..1 Reference(Procedure) "Bildgebungsprozedur" "Referenz auf die dazugehörige bildgebende Prozedur der Studie. Hier soll auf das MII KDS-Modul Prozedur referenziert werden."
  ...
  * Koerpergewicht 0..1 Reference($de-weight) "Gewicht" "Körpergewicht des Patienten"
  * Koerpergroesse 0..1 Reference($de-height) "Größe" "Körpergröße des Patienten"
  ...
  * Serien 0..* BackboneElement "Serien" "Die Serien der DICOM-Studie"
    ...
    * Schichtdicke 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Schichtdicke" "Schichtdicke über die gesamte Serie hinweg"
    ...
    * ModalitaetCT 0..1 BackboneElement "Modalitaet CT" "Modalitaet Computertomographie"
      ...
      * Exposition 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Exposition" "Exposition in MAs"
      * Roentgenroehrenstrom 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Röntgenröhrenstrom" "Röntgenröhrenstrom in mA"
      * Filterkern 0..1 http://hl7.org/fhir/StructureDefinition/string "Filterkern" "Genutzter Filterkern in der Reskonstruktion"
    * ModalitaetMR 0..1 BackboneElement "Modalitaet MR" "Modalitaet Kernspintomographie"
      ...
      * ScanningSequenzUntervariante 0..* http://hl7.org/fhir/StructureDefinition/CodeableConcept "Scanning Sequenz Untervariante" "Code der aktuellen Scanning Sequenz Untervariante"
    ...
    * ModalitaetPT 0..1 BackboneElement "Modalitaet PT" "Modalitaet PET-Scan"
      ...
      * Serientyp 0..* http://hl7.org/fhir/StructureDefinition/CodeableConcept "Serientyp" "Angabe, um welchen Typ von Serie es sich handelt"
    * ModalitaetNM 0..1 BackboneElement "Modalitaet NM" "Modalitaet Nuklearmedizin"
      ...
      * GesamteRadionukliddosis 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Gesamte Radionukliddosis" "Gesamte verabreichte Radionukliddosis in MBq"
      * Halbwertszeit 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Halbwertszeit" "Halbwertszeit des Radionuklids in s"
    * ModalitaetUS 0..1 BackboneElement "Modalitaet US" "Modalitaet Ultraschall"
      * Schallkopftyp 0..1 http://hl7.org/fhir/StructureDefinition/CodeableConcept "Schallkopftyp" "Typ des genutzten Schallkopfes"
      * Schallkopffrequenz 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Schallkopffrequenz" "Frequenz des genutzten Schallkopfes"
      * Impulsfolgefrequenz 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Impulsfolgefrequenz" "Frequenz der aufeinanderfolgenden Impulse des Schallkopfes"
      * Ultraschallfarbe 0..1 http://hl7.org/fhir/StructureDefinition/boolean "Ultraschallfarbe" "Angabe, ob der Ultraschall in Farbe aufgenommen wurde"
    * Instanzen 0..* BackboneElement "Instanzen" "Alle Instanzen dieser DICOM-Serie."
      ...
      * Bildtyp 0..* http://hl7.org/fhir/StructureDefinition/CodeableConcept "Bildtyp" "Bildtyp der Instanz"
      ...
      * EingebrannteAnnotation 0..1 http://hl7.org/fhir/StructureDefinition/boolean "Eingebrannte Annotation" "Information über das Vorhandensein einer eingebrannten Annotation in dieser SOP-Instanz"
...
* Studie -> "ImagingStudy"
  ...
  * Koerpergewicht -> "ImagingStudy.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-gewicht)"
  * Koerpergroesse -> "ImagingStudy.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-groesse)"
  * Serien -> "ImagingStudy.series"
    ...
    * Schichtdicke -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-serie-schichtdicke/sliceThickness)"
    ...
    * ModalitaetCT -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-ct)"
      ...
      * Filterkern -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-ct/convolutionalKernel)"
    ...
    * ModalitaetUS -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-us)"
      * Schallkopftyp -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-us/transducerType)"
      * Schallkopffrequenz -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-us/transducerFrequency)"
      * Impulsfolgefrequenz -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-us/pulseRepetitionFrequency)"
      * Ultraschallfarbe -> "ImagingStudy.series.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-us/ultrasoundColor)"
    ...
    * Instanzen -> "ImagingStudy.series.instance"
      ...
      * EingebrannteAnnotation -> "ImagingStudy.series.instance.extension(https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-instanz-details/burnedInAnnotation)"
...
* Geraet -> "https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-pr-bildgebung-geraet"
