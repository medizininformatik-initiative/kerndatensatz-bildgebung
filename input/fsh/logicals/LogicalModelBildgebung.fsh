...
* Koerperstruktur 0..1 BackboneElement "Körperstruktur" "untersuchte Körperstruktur"
  ...
  * Person 0..1 Reference(Patient) "Person" "Person, an der sich die untersuchte Körperstruktur befindet."
* Empfehlung 0..* BackboneElement "Empfehlung" "Therapieempfehlungen aus vorherigen Behandlungen"
  ...
  * Person 1..1 Reference(Patient) "Person" "Person, auf die sich die Empfehlung bezieht"
