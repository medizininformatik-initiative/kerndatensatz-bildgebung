ValueSet: MII_VS_Bildgebung_PT_Series_Type_Spacial
...
* ^experimental = false
* MII_CS_Bildgebung_Series_Type#STATIC
* MII_CS_Bildgebung_Series_Type#DYNAMIC
* MII_CS_Bildgebung_Series_Type#GATED
* MII_CS_Bildgebung_Series_Type#WHOLEBODY