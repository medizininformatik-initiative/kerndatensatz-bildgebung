...
* insert SupportSearchParam(imaging-tudy, https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/SearchParameter/mii-sp-bildgebung-diagnostic-report-imaging-study, #reference, #SHALL)
...
* insert SupportSearchParam(_profile, http://hl7.org/fhir/SearchParameter/Resource-profile, #uri, #SHALL)
* insert SupportSearchParam(_source, http://hl7.org/fhir/SearchParameter/Resource-source, #uri, #SHALL)
* insert SupportSearchParam(bildgebungsgrund, , #string, #SHALL)
* insert SupportSearchParam(modality, , #token, #SHALL)
* insert SupportSearchParam(patient, http://hl7.org/fhir/SearchParameter/ImagingStudy-modality, #reference, #SHALL)
...
* insert SupportSearchParam(number-series, , #number, #SHALL)
* insert SupportSearchParam(number-instance, , #number, #SHALL)
* insert SupportSearchParam(procedure-reference, , #reference, #SHALL)
...
* insert SupportSearchParam(description, https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/SearchParameter/mii-sp-bildgebung-description, #string, #SHALL)
* insert SupportSearchParam(CTDI-volume, , #quantity, #SHALL)
* insert SupportSearchParam(tubeVoltage, , #quantity, #SHALL)
* insert SupportSearchParam(exposure-time-ct, , #quantity, #SHALL)
* insert SupportSearchParam(exposure-ct, , #quantity, #SHALL)
* insert SupportSearchParam(x-ray-tube-current-ct, , #quantity, #SHALL)
* insert SupportSearchParam(kvp, , #quantity, #SHALL)
* insert SupportSearchParam(exposure-time-mmg, , #quantity, #SHALL)
* insert SupportSearchParam(exposure-mg, , #quantity, #SHALL)
* insert SupportSearchParam(x-ray-tube-current-mg, , #quantity, #SHALL)
* insert SupportSearchParam(mag-field-strength, , #quantity, #SHALL)
* insert SupportSearchParam(scanning-seq, , #token, #SHALL)
* insert SupportSearchParam(scanning-seq-variant, , #token, #SHALL)
* insert SupportSearchParam(radiopharmakon, , #token, #SHALL)
* insert SupportSearchParam(start-time, , #date, #SHALL)
* insert SupportSearchParam(rescale-type, , #token, #SHALL)
* insert SupportSearchParam(total-dose, , #quantity, #SHALL)
* insert SupportSearchParam(halflife, , #quantity, #SHALL)
* insert SupportSearchParam(contrast-bolus, , #token, #SHALL)
* insert SupportSearchParam(contrast-bolus-details, , #reference, #SHALL)
* insert SupportSearchParam(manufacturer, , #string, #SHALL)
* insert SupportSearchParam(modelname, , #string, #SHALL)
* insert SupportSearchParam(series, http://hl7.org/fhir/SearchParameter/ImagingStudy-series, #token, #SHALL)
* insert SupportSearchParam(series-number, , #number, #SHALL)
...
* insert SupportSearchParam(series-number-instance, , #number, #SHALL)
* insert SupportSearchParam(series-bodysite, http://hl7.org/fhir/SearchParameter/ImagingStudy-bodysite, #quantity, #SHALL)
* insert SupportSearchParam(series-laterality, , #token, #SHALL)
* insert SupportSearchParam(series-started, , #date, #SHALL)
* insert SupportSearchParam(instance-pixel-spacing-x, , #string, #SHALL)
* insert SupportSearchParam(instance-pixel-spacing-y, , #string, #SHALL)
* insert SupportSearchParam(instance-slice-thickness, , #number, #SHALL)
* insert SupportSearchParam(instance-image-type, , #string, #SHALL)
...
* insert SupportSearchParam(instance-number, , #number, #SHALL)
...
* insert SupportSearchParam(_profile, http://hl7.org/fhir/SearchParameter/Resource-profile, #uri, #SHALL)
* insert SupportSearchParam(_source, http://hl7.org/fhir/SearchParameter/Resource-source, #uri, #SHALL)
* insert SupportSearchParam(bildnummer, https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/SearchParameter/mii-sp-bildgebung-observation-bildnummer, #number, #SHALL)
* insert SupportSearchParam(sop-instance, https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/SearchParameter/mii-sp-bildgebung-observation-sop-instance, #token, #SHALL)
