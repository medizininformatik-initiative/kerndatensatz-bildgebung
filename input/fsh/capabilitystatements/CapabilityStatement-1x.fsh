...
* insert SupportSearchParam(type, http://hl7.org/fhir/SearchParameter/Composition-type, #token, #SHALL)
* insert SupportSearchParam(description, https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/SearchParameter/mii-sp-bildgebung-care-plan-description, #token, #SHALL)
* insert SupportSearchParam(subject, http://hl7.org/fhir/SearchParameter/Composition-subject, #reference, #SHALL)
* insert SupportSearchParam(date, http://hl7.org/fhir/SearchParameter/Composition-date, #date, #SHALL)
...
* insert SupportSearchParam(section.code, http://hl7.org/fhir/SearchParameter/Composition-section-code, #string, #SHALL)
