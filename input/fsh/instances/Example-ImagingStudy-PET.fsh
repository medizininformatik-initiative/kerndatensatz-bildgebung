...
* series.extension[https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-pt].extension[units].valueCodeableConcept.coding = $ucum#BQML
...
* series.extension[https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-pt].extension[seriesType].valueCodeableConcept.coding[spacial] = MII_CS_Bildgebung_Series_Type#DYNAMIC
* series.extension[https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-pt].extension[seriesType].valueCodeableConcept.coding[volumetric] = MII_CS_Bildgebung_Series_Type#IMAGE
