...
## Extension: MII EX Bildgebung Bildnummer 
...
| Active Stand: 2026-08-27 | *Maschinenlesbarer Name*:MII_EX_Bildgebung_Serie_UID |
...
Simple Extension with the type id: Die Extension ermöglicht es, den Bildnummer aus dem entsprechenden DICOM Tag auf Studien-Ebene anzugeben.
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-ex-bildgebung-serie-uid.csv), [Excel](../StructureDefinition-mii-ex-bildgebung-serie-uid.xlsx), [Schematron](../StructureDefinition-mii-ex-bildgebung-serie-uid.sch) 
