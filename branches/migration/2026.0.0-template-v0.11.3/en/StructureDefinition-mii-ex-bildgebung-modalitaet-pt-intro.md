<!-- TODO:REVIEW machine translation of source page StructureDefinition-mii-ex-bildgebung-modalitaet-pt-intro.md (de) -->
The PT (positron emission tomography) extension enables the capture of relevant DICOM tags in order to draw conclusions about how the images were acquired.
...
- Total radionuclide dose ["0018, 1074" RadionuclideTotalDose] in _becquerel [Bq]_ (note: for NM, the unit MBq is normally used instead!)
