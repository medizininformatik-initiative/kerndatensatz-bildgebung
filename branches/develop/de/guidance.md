# Anleitung - MII IG Kerndatensatz-Modul Bildgebung v2027.0.0-ballot.1
...
Diese Seite bündelt den fachlichen Einstieg in das Modul **Bildgebung**: Anwendungsszenarien, die [UML-Diagramme](uml-diagrams.md) des Informationsmodells sowie die [Hinweise für Implementierende](implementer-guidance.md).
