...
* **MII VS Bildgebung Instance Image Type NM Implementation**

## ValueSet: MII VS Bildgebung Instance Image Type NM Implementation 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/ValueSet/mii-vs-bildgebung-instance-image-type-nm-implementation | *Version*:2027.0.0-ballot.1 |
| Active as of 2026-09-15 | *Computable Name*:MII_VS_Bildgebung_Instance_Image_Type_NM_Implementation |

 
Import the ValueSet for Instance Image Type NM Implementation 
...
```json
{
  ...
  "id" : "mii-vs-bildgebung-instance-image-type-nm-implementation",
  "meta" : {
