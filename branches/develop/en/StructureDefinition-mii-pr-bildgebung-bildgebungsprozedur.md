# MII PR Bildgebung Bildgebungsprozedur - MII IG Kerndatensatz-Modul Bildgebung v2027.0.0-ballot.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Bildgebung Bildgebungsprozedur**

## Resource Profile: MII PR Bildgebung Bildgebungsprozedur 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-pr-bildgebung-bildgebungsprozedur | *Version*:2027.0.0-ballot.1 |
| Active as of 2026-09-15 | *Computable Name*:MII_PR_Bildgebung_Bildgebungsprozedur |

 
The profile describes a advisory for medical care. 

This Procedure resource is used to record the imaging procedure. It offers the possibility to use the contrast administration both with the diagnostic report and with the DICOM metadata.
...
Example of a Procedure resource relating to the imaging:

[Procedure-mii-exa-bildgebung-bildgebungsprozedur](Procedure-mii-exa-bildgebung-bildgebungsprozedur.md)

**Usages:**

* Examples for this Profile: [Procedure/mii-exa-bildgebung-bildgebungsprozedur](Procedure-mii-exa-bildgebung-bildgebungsprozedur.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.bildgebung|current/StructureDefinition/StructureDefinition-mii-pr-bildgebung-bildgebungsprozedur.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-bildgebung-bildgebungsprozedur.csv), [Excel](../StructureDefinition-mii-pr-bildgebung-bildgebungsprozedur.xlsx), [Schematron](../StructureDefinition-mii-pr-bildgebung-bildgebungsprozedur.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/ValueSet/mii-vs-bildgebung-imaging-procedure-code-sct"
      }
    },
    {
