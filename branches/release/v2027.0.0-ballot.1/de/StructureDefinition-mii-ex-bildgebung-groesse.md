# MII EX Bildgebung Körpergröße - MII IG Kerndatensatz-Modul Bildgebung v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII EX Bildgebung Körpergröße**

## Extension: MII EX Bildgebung Körpergröße 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-groesse | *Version*:2027.0.0-ballot.1 |
| Active Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_EX_Bildgebung_Groesse |

Die Extension ermöglicht es, die Körpergröße aus dem entsprechenden DICOM Tag [0010,1020] auf Studien-Ebene anzugeben.
...
Simple Extension with the type Reference: Die Extension ermöglicht es, die Körpergröße aus dem entsprechenden DICOM Tag [0010,1020] auf Studien-Ebene anzugeben.
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-ex-bildgebung-groesse.csv), [Excel](../StructureDefinition-mii-ex-bildgebung-groesse.xlsx), [Schematron](../StructureDefinition-mii-ex-bildgebung-groesse.sch) 
