# MII EX Bildgebung Körpergewicht - MII IG Kerndatensatz-Modul Bildgebung v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII EX Bildgebung Körpergewicht**

## Extension: MII EX Bildgebung Körpergewicht 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-gewicht | *Version*:2027.0.0-ballot.1 |
| Active Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_EX_Bildgebung_Gewicht |
...
Simple Extension with the type Reference: Die Extension ermöglicht es, das Körpergewicht aus dem entsprechenden DICOM Tag [0010,1030] auf Studien-Ebene anzugeben.
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-ex-bildgebung-gewicht.csv), [Excel](../StructureDefinition-mii-ex-bildgebung-gewicht.xlsx), [Schematron](../StructureDefinition-mii-ex-bildgebung-gewicht.sch) 
