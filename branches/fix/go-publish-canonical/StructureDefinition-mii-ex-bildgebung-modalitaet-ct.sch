...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'CTDIvol']) &lt;= 1">extension with URL = 'CTDIvol': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'KVP']) &lt;= 1">extension with URL = 'KVP': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'exposureTime']) &lt;= 1">extension with URL = 'exposureTime': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'xRayTubeCurrent']) &lt;= 1">extension with URL = 'xRayTubeCurrent': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'convolutionalKernel']) &lt;= 1">extension with URL = 'convolutionalKernel': maximum cardinality of 'extension' is 1</sch:assert>
