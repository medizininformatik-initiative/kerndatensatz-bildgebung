# MII PR Bildgebung Anforderung Bildgebung - MII IG Kerndatensatz-Modul Bildgebung v2027.0.0-ballot.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Bildgebung Anforderung Bildgebung**

## Resource Profile: MII PR Bildgebung Anforderung Bildgebung 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-pr-bildgebung-anforderung-bildgebung | *Version*:2027.0.0-ballot.1 |
| Active as of 2026-09-15 | *Computable Name*:MII_PR_Bildgebung_Anforderung_Bildgebung |

 
The profile describes a service request. 

This ServiceRequest resource is used to record a request for an imaging procedure. It serves as the starting point for a diagnostic report and likewise for the acquisition of an imaging study.
...
Example of a ServiceRequest resource:

[ServiceRequest-mii-exa-bildgebung-anforderung-bildgebung](ServiceRequest-mii-exa-bildgebung-anforderung-bildgebung.md)

**Usages:**

* Refer to this Profile: [MII PR Bildgebung Bildgebungsprozedur](StructureDefinition-mii-pr-bildgebung-bildgebungsprozedur.md) and [MII PR Bildgebung Radiologischer Befund](StructureDefinition-mii-pr-bildgebung-radiologischer-befund.md)
* Examples for this Profile: [ServiceRequest/mii-exa-bildgebung-anforderung-bildgebung](ServiceRequest-mii-exa-bildgebung-anforderung-bildgebung.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.bildgebung|current/StructureDefinition/StructureDefinition-mii-pr-bildgebung-anforderung-bildgebung.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-bildgebung-anforderung-bildgebung.csv), [Excel](../StructureDefinition-mii-pr-bildgebung-anforderung-bildgebung.xlsx), [Schematron](../StructureDefinition-mii-pr-bildgebung-anforderung-bildgebung.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "ServiceRequest.category.coding:sct",
      "path" : "ServiceRequest.category.coding",
      "sliceName" : "sct",
    ...
    {
      "id" : "ServiceRequest.reasonCode.coding:sct",
      "path" : "ServiceRequest.reasonCode.coding",
      "sliceName" : "sct",
      "short" : "SNOMED CT Code",
      "_short" : {
