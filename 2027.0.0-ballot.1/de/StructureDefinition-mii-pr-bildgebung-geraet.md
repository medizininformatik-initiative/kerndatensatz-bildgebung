# MII PR Bildgebung Gerät - MII IG Kerndatensatz-Modul Bildgebung v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Bildgebung Gerät**

## Ressourcenprofil: MII PR Bildgebung Gerät 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-pr-bildgebung-geraet | *Version*:2027.0.0-ballot.1 |
| Active Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_Bildgebung_Geraet |

 
Darstellung des Bildgebungsgerät 
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-bildgebung-geraet.csv), [Excel](../StructureDefinition-mii-pr-bildgebung-geraet.xlsx), [Schematron](../StructureDefinition-mii-pr-bildgebung-geraet.sch) 
